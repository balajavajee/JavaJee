package com.microservices.msthree.config;
...
public class MySQLAutoconfiguration {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/mysqldb?createDatabaseIfNotExist=true");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan("com.microservices.msone");
