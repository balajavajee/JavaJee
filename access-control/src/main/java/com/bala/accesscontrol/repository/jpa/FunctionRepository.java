...
@Repository
public interface FunctionRepository<T extends BaseEntity, ID> extends JpaRepository<T, ID>, PagingAndSortingRepository<T, ID> /*extends BaseRepository<Function, Long>*/ {
